...
<aside id="sidebar-multi-level-sidebar" class=" w-64 h-screen navbar-sticky-side bg-green-800" aria-label="Sidebar">
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-primary">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-nav-link aria-controls="dropdown-pembayaran" data-collapse-toggle="dropdown-pembayaran" :active="request()->routeIs('admin.manage-jenis-pembayaran') || request()->routeIs('admin.edit-jenis-pembayaran') || request()->routeIs('admin.create-jenis-pembayaran')"
                ...
                <ul id="dropdown-pembayaran"
                    class="py-2 space-y-2 {{ request()->routeIs('admin.manage-jenis-pembayaran') || request()->routeIs('admin.create-jenis-pembayaran') || request()->routeIs('admin.edit-jenis-pembayaran') || request()->routeIs('admin.perpindahan-jenis-pembayaran') ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('admin.manage-jenis-pembayaran') }}"
                            ...
                            {{ request()->routeIs('admin.manage-jenis-pembayaran') || request()->routeIs('admin.create-jenis-pembayaran') || request()->routeIs('admin.edit-jenis-pembayaran') ? 'bg-green-900' : '' }}">CRU
                            POS Bayar</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.tagihan-jenis-pembayaran') }}"
                            class="flex items-center w-full p-2 text-green-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-100 dark:text-white dark:hover:bg-green-700
                            {{ request()->routeIs('admin.tagihan-jenis-pembayaran') ? 'bg-green-900' : '' }}">Tagihan Pembayaran</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.laporan-jenis-pembayaran') }}"
                            class="flex items-center w-full p-2 text-green-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-100 dark:text-white dark:hover:bg-green-700
                            {{ request()->routeIs('admin.laporan-jenis-pembayaran') ? 'bg-green-900' : '' }}">laporan Pembayaran</a>
                    </li>
                </ul>
            </li>
            <li>
